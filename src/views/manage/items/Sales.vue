<script setup>
    ...
    onMounted(() => {
        emit("update-breadcrumbs", [{label: "Manage"}, {label: "Items"}, {label: "Sales", to: "/manage/items/sales"}]);
        loadItems();
...
<template>
    ...
    <Table ref="sales_table" v-model:selection="selection" v-model:editingRows="editingRows" title="Sales Items" :loading="isLoading" :value="items" dataKey="id" :saveEdit="editItem">
